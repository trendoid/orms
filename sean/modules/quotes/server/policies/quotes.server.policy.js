...
exports.isAllowed = function(req, res, next) {
  ...
  // If an quote is being processed and the current user created it then allow any manipulation
  if (req.quote && req.user && req.quote.userId === req.user.id) {
    return next();
  }
